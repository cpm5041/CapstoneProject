...
/***/ (function(module, exports, __webpack_require__) {
	...
	var petEvents = __webpack_require__(7);
...
/***/ (function(module, exports) {
	...
	var config = {
	  apiOrigins: {
	    production: 'https://fathomless-peak-62210.herokuapp.com/'
	  }
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var checkForBlanks = function checkForBlanks(data) {
	  // check to see if user entered valid values in form fields
	  var userName = data.pet.name.replace(/ +?/g, '');
	  var userSpecies = data.pet.species.replace(/ +?/g, '');
	  var userBreed = data.pet.breed.replace(/ +?/g, '');
	  if (userName.length === 0 || userSpecies.length === 0 || userBreed.length === 0) {
	...
	var onCreatePet = function onCreatePet(event) {
	  ...
	  ();var data = getFormFields(event.target // same as this
	    ...
	    $('#fail-pet-create-alert').fadeTo(1500, 500).slideUp(500, function () {
	    ...
	    api.createPet(data).then(ui.createPetSuccess).catch(ui.createPetFailure).done(onGetPets);
	  }
	};
	var onGetAllPets = function onGetAllPets(event) {
	  api.getAllPets().then(ui.getAllPetsSuccess).catch(ui.getAllPetsfailure);
	};
	var onGetPets = function onGetPets(event) {
	  api.getPets().then(ui.getPetsSuccess).catch(ui.getPetsfailure);
	};
	var onRemovePet = function onRemovePet() {
	  event.preventDefault();
	  var data = $(this).attr('data-id');
	  api.removePet(data).then(ui.removePetSuccess).catch(ui.removePetFail).done(onGetPets);
	};
	var onUpdatePet = function onUpdatePet(event) {
	  ...
	  if (checkForBlanks(data)) {
	    ...
	    // if no blanks - send ajax request
	    api.updatePets(petId, data).done(ui.updatePetsSuccess).catch(ui.updatePetFail).done(onGetPets);
	  }
	};
	var addPetHandlers = function addPetHandlers() {
	...
	module.exports = {
	  ...
	  addPetHandlers: addPetHandlers,
	  onGetPets: onGetPets,
	  onRemovePet: onRemovePet,
	  onUpdatePet: onUpdatePet,
	  checkForBlanks: checkForBlanks
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var getAllPets = function getAllPets() {
	  return $.ajax({
	    url: config.apiOrigin + '/pets',
	    method: 'GET'
	  });
	};
	var getCurrentUserPages = function getCurrentUserPages() {
	  return $.ajax({
	...
	var updatePets = function updatePets(petId, data) {
	  return $.ajax({
	...
	var removePet = function removePet(data) {
	  return $.ajax({
...
/***/ (function(module, exports, __webpack_require__) {
	...
	);var showPetsTemplate = __webpack_require__(12);
	var showAllPetsTemplate = __webpack_require__(32);
	...
	var createPetSuccess = function createPetSuccess(data) {
	  ...
	  $('#success-pet-create-alert').fadeTo(1500, 500).slideUp(500, function () {
	    $('#success-pet-create-alert').slideUp(500);
	  });
	  $('html, body').animate({ scrollTop: 0 }, 'fast');
	};

	var createPetFailure = function createPetFailure() {
	  $('#fail-pet-create-alert').alert();
	  $('#fail-pet-create-alert').fadeTo(1500, 500).slideUp(500, function () {
	    $('#fail-pet-create-alert').slideUp(500);
	  });
	...
	var getPetsSuccess = function getPetsSuccess(data) {
	  ...
	  if (data.pets.length === 0) {
	    ...
	    var showPetsHtml = showPetsTemplate({
	      pets: data.pets
	    });
	    $('#getPetHbDiv').html(showPetsHtml);
	  }
	};
	var getAllPetsSuccess = function getAllPetsSuccess(data) {
	  // if logic to handle showing a message to the user if they have posted no blogs
	  if (data.pets.length === 0) {
	    $('#getPetHbDiv').html('You have not added any pets!'
	    // else condition to show blogs
	    ...
	    var showPetsHtml = showAllPetsTemplate({
	      pets: data.pets
	    });
	    $('#getAllPetHbDiv').html(showPetsHtml);
	  }
	};
	var getPetsFailure = function getPetsFailure(data) {};

	var removePetFail = function removePetFail(data) {};

	var updatePetsSuccess = function updatePetsSuccess(data) {
	  $('.update-pet-modal').modal('toggle');
	  $('body').removeClass('modal-open');
	  $('.modal-backdrop').remove();
	  $('#success-pet-update-alert').alert();
	  $('#success-pet-update-alert').fadeTo(1500, 500).slideUp(500, function () {
	    $('#success-pet-update-alert').slideUp(500);
	  });
	  $('html, body').animate({ scrollTop: 0 }, 'fast');
	};

	var updatePetsFail = function updatePetsFail(data) {
	  $('#fail-pet-update-alert').alert();
	  $('#fail-pet-update-alert').fadeTo(1500, 500).slideUp(500, function () {
	    $('#fail-pet-update-alert').slideUp(500);
	  });
	  $('html, body').animate({ scrollTop: 0 }, 'fast');
	};

	var removePetSuccess = function removePetSuccess(data) {
	  $('body').removeClass('modal-open');
	  $('.modal-backdrop').remove();
	  $('.pet-delete-alert-success').alert();
	  $('.pet-delete-alert-success').fadeTo(1500, 500).slideUp(500, function () {
	...
	module.exports = {
	  ...
	  createPetFailure: createPetFailure,
	  getPetsSuccess: getPetsSuccess,
	  getPetsFailure: getPetsFailure,
	  removePetFail: removePetFail,
	  updatePetsSuccess: updatePetsSuccess,
	  updatePetsFail: updatePetsFail,
	  removePetSuccess: removePetSuccess,
	  getAllPetsSuccess: getAllPetsSuccess
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "    <li data-id: \""
	    ...
	    + "\" class='this"
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    + " hbStyle allHbStyle col-md-12 list-unstyled text-center'>\n      <div class='container row '>\n        <div class='col-md-4 nameDiv backgroundCss'>\n          <h2>Name: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
	    + "</h2>\n          <p>Species: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.species : stack1), depth0))
	    + "</p>\n          <p>Breed: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.breed : stack1), depth0))
	    + "</p>\n          <p>Birthday: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.bornOn : stack1), depth0))
	    + "</p>\n          <p>Gender: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.gender : stack1), depth0))
	    + "</p>\n        </div>\n\n        <div class='col-md-6 imageDiv'>\n"
	    + ((stack1 = helpers["if"].call(depth0 != null ? depth0 : (container.nullContext || {}),((stack1 = blockParams[0][0]) != null ? stack1.image : stack1),{"name":"if","hash":{},"fn":container.program(2, data, 0, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "        </div>\n        <!-- Delete Comments -->\n        <br>\n        <div class='buttonsDiv col-md-12'>\n        <button type=\"button\" class=\"updatePet btn btn-primary handle\" data-toggle=\"modal\" data-target=\"#updatepetmodal"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">Update Pet Info</button>\n        <button type=\"button\" class=\"removePet remove-pet btn btn-danger handle\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">Remove Pet</button>\n\n        <div class=\"modal fade update-pet-modal\" id=\"updatepetmodal"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"exampleModalLongTitle\" aria-hidden=\"true\">\n          <div class=\"modal-dialog\" role=\"document\">\n            <div class=\"modal-content\">\n              <div class=\"modal-header\">\n                <h5 class=\"modal-title\" id=\"exampleModalLongTitle\">Update Pet Info</h5>\n              </div>\n              <div class=\"modal-body\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n                <form id='clearUpdatePet' class=\"update-pet\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n                  <fieldset>\n                    Name:<input type='text' id=\"NameUpdateForm\" name='pet[name]' placeholder='Enter Name' required></input>\n                    <br> Species\n                    <input type='text' id=\"SpeciesUpdateForm\" name='pet[species]' placeholder='Enter Species' required></input>\n                    <br> Breed:\n                    <input type='text' id=\"BreedUpdateForm\" name='pet[breed]' placeholder='Enter Breed' required></input>\n                    <br> Image URL:<input type='text' id=\"ImageUpdateForm\" name='pet[image]' placeholder='Enter Image'></input>\n                    <br> Birthday:\n                    <input type='date' id=\"bornOnUpdateForm\" name='pet[bornOn]' placeholder='Enter Date of Birth (YYYY-MM-DD)' required></input>\n                    <br>\n                    <label for=\"gender\">Choose Gender</label>\n                    <select id=\"GenderUpdateForm\" name='pet[gender]' name='gender'>\n               <option value=\"female\">Female</option>\n               <option value=\"male\">Male</option>\n\n             </select>\n                    <br>\n                    <input data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" type=\"submit\" name=\"submit\" value=\"Update Pet\">\n                  </fieldset>\n                </form>\n              </div>\n              <div class=\"modal-footer\">\n                <div class=\"updateerror\"></div>\n                <button type=\"button\" class=\"btn btn-secondary\" data-dismiss=\"modal\">Cancel</button>\n              </div>\n            </div>\n          </div>\n        </div>\n      </div>\n      </div>\n\n      <hr>\n    </li>\n";
	},"2":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return "            <img src= "
	    + container.escapeExpression(container.lambda(((stack1 = blockParams[1][0]) != null ? stack1.image : stack1), depth0))
	    + " class='petImage img-responsive' alt=\"Image not found\"></img>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return "<ul>\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.pets : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "\n</ul>\n";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "    <li data-id: \""
	    ...
	    + "\" class='this"
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    + " allHbStyle col-md-12 list-unstyled text-center'>\n      <div class='container row '>\n        <div class='col-md-4 nameDiv backgroundCss'>\n          <h2>Name: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
	    + "</h2>\n          <p>Species: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.species : stack1), depth0))
	    + "</p>\n          <p>Breed: "
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onSignUp = function onSignUp(event) {
	  ...
	  var data = getFormFields(event.target // 'this' is reffering to event.target
	...
	var clearModals = function clearModals() {
	  $('.form-control').val('');
	  $('.error-clear').text('');
	};
	// event handlers for auth events
	var addAuthHandlers = function addAuthHandlers() {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var signUpSuccess = function signUpSuccess(data) {
	  ...
	  };api.signIn({ credentials: credentials }).then(signInSuccess).catch(signInFailure
	  // clear input fields
	  );$('#sign-up-email').val('');
